...
public class CreativeFieldParserEntry {
	...
	static {
		...
		registerParser(NBTTagCompound.class, new NBTTagCompoundFieldParser());
		...
		registerParser(IBlockState.class, new IBlockStateFieldParser());
	...
	public static class NBTTagCompoundFieldParser extends CreativeFieldParserType<NBTTagCompound> {
		
		@Override
		protected void writeContent(NBTTagCompound content, PacketBuffer buffer) {
			buffer.writeCompoundTag(content);
		}
		
		@Override
		protected NBTTagCompound readContent(PacketBuffer buffer) {
	...
	public static class IBlockStateFieldParser extends CreativeFieldParserType<IBlockState> {
		
		@Override
		protected void writeContent(IBlockState content, PacketBuffer buffer) {
			buffer.writeInt(Block.getStateId(content));
		}
		
		@Override
		protected IBlockState readContent(PacketBuffer buffer) {
