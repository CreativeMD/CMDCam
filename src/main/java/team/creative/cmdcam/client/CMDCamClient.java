...
public class CMDCamClient {
	...
	public static void init(FMLClientSetupEvent event) {
		...
		ClientCommandRegistry.register(LiteralArgumentBuilder.<ISuggestionProvider>literal("cam").executes((x) -> {
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam add [number] " + TextFormatting.RED + "register a point at the current position"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam clear " + TextFormatting.RED + "delete all registered points"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam start [time|ms|s|m|h|d] [loops (-1 -> endless)] " + TextFormatting.RED + "starts the animation"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam stop " + TextFormatting.RED + "stops the animation"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam goto <index> " + TextFormatting.RED + "tp to the given point"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam set <index> " + TextFormatting.RED + "updates point to current location"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam remove <index> " + TextFormatting.RED + "removes the given point"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam target <none:self> " + TextFormatting.RED + "set the camera target"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam mode <default:outside> " + TextFormatting.RED + "set current mode"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam interpolation <" + String.join(":", CamInterpolation.getMovementNames()) + "> " + TextFormatting.RED + "set the camera interpolation"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam follow-speed <number> " + TextFormatting.RED + "default is 1.0"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam show <all:" + String.join(":", CamInterpolation.getMovementNames()) + "> " + TextFormatting.RED + "shows the path using the given interpolation"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam hide <all:" + String.join(":", CamInterpolation.getMovementNames()) + "> " + TextFormatting.RED + "hides the path using the given interpolation"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam save <name> " + TextFormatting.RED + "saves the current path (including settings) with the given name"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam load <name> " + TextFormatting.RED + "tries to load the saved path with the given name"), Util.DUMMY_UUID);
			mc.player.sendMessage(new StringTextComponent("" + TextFormatting.BOLD + TextFormatting.YELLOW + "/cam list " + TextFormatting.RED + "lists all saved paths"), Util.DUMMY_UUID);
			return 0;
