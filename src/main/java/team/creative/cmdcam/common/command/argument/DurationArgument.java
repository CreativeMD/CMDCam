...
public class DurationArgument implements ArgumentType<Long> {
    ...
    public Long parse(StringReader reader) throws CommandSyntaxException {
        ...
        if (type.equalsIgnoreCase("ms"))
            ...
            throw new CommandSyntaxException(new SimpleCommandExceptionType(new LiteralMessage("Invalid time format try out 10s (for 10 seconds)")), new TranslatableComponent("invalid_time_format"));
        }
